<template>
    <div>
        <el-card>
            ...
            <!-- <i class="iconfont icon-txm-love" style="font-size: 18px;"><b>科室门诊</b></i> -->
            <el-divider></el-divider>
            <div class="sectionIndex" style="font-size: 24px">
                <i class="iconfont icon-txm-love" style="font-size: 22px"></i>
                <b> 内科类</b>
            </div>
            <!-- <i class="iconfont icon-txm-love" style="font-size: 18px;"><b> 内科</b></i> -->
            <ul>
            ...
            <ul>
                <li v-for="out in outs" :key="out">
                    <el-button type="primary" style="margin: 5px" size="mini" @click="sectionClick(out)">{{
                        out
                    }}</el-button>
                </li>
            </ul>
            ...
            <ul>
                <li v-for="kid in kids" :key="kid">
                    <el-button type="primary" style="margin: 5px" size="mini" @click="sectionClick(kid)">{{
                        kid
                    }}</el-button>
                </li>
            </ul>
            ...
            <ul>
                <li v-for="five in fives" :key="five">
                    <el-button type="primary" style="margin: 5px" size="mini" @click="sectionClick(five)">{{
                        five
                    }}</el-button>
                </li>
            </ul>
